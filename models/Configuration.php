...
class Configuration extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['root_space_id', 'authority_user_id', 'company_user_id'], 'default', 'value' => null],
            [['root_space_id', 'authority_user_id', 'company_user_id'], 'integer', 'min' => 1],
            ['work_auto_archive_days', 'integer', 'min' => 0],
            ...
            ['company_user_id', 'exist', 'targetClass' => \humhub\modules\user\models\User::class, 'targetAttribute' => 'id'],
        ];
    }
